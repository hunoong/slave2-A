...
////--------------------------------<BRUSH 01>
      ...
      if(detection.label === 'person'){  
        ...
        //brushes.push(new Brush(detection.x+detection.width/2, detection.y+detection.height/2, 20));
...
////--------------------------------<BRUSH 02>
        ...
        //brushes.push(new Brush(detection.x+detection.width/2, detection.y+detection.height/2, 20,10));
...
function mousePressed(){
 ...
 brushes.push(new Brush(mouseX,mouseY,10 ));
}
