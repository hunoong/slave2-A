...
function setup() {
  ...
  video.size(640,480);
  video.position(windowWidth/2,windowHeight/2);
  //video.hide();
...
text(results[0].label, 50, 50+20*r); //or something similar. if that still is an ‘object' then you can do one more step like results[0][0]…
}
}
