...
// ellipse to make text unclear to read
  ...
  ellipse(windowWidth/2-8,windowHeight/2-8,152,152);
...
// introduction for users
  fill(160);
  textSize(12);
  text('This program is designed to track algorithmic movement of birds. It might take some time to launch the detector. If the bird cursor is following, then it is good to go.', windowWidth/2,windowHeight-50);
...
// the main title
 ...
 text("The Beauty of the Eaten Path",windowWidth/2,windowHeight/2-265);
...
//---brushes for living creatures------------------------------------------------
    ...
    extraCanvas.tint(0,random(50,255));    
    extraCanvas.image(conteBrush, detection.x+detection.width/2,detection.y+detection.height/2,30,30); 
    }
